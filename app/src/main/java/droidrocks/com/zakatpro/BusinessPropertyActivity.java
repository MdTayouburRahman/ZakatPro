...
public class BusinessPropertyActivity extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "";
    private TextInputEditText nisab, editText1, editText2, editText3, editText4, editText5, editText6, editText8, editTextExcludeMoney;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_business_property);
    ...
    private void init() {
        ...
        Button calculation = findViewById(R.id.calculationID);
    ...
    public void zakatData() {
        ...
        double zakatAmmoutn = zakatCalculation.BusinessPropertyCalculation( this,nisabvalue, data1, data2,
                data3, data4, data5,data6, data8, excluedData);
        ...
        int totalZakatProperty = zakatCalculation.TotalBusinessZakatProperty(data1, data2, data3, data4, data5, data6, data8, excluedData);
    ...
    private void topBar() {
        ...
        String page_title = intentData.getStringExtra("pageTitle");
